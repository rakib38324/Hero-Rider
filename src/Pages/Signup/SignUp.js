  ...
  return (
    <div className="bg-gray-200">
      <div>
        ...
        {
          loading? <div className="pt-16 flex justify-center">  <SmallLoading></SmallLoading> <p className="text-xl ml-2 font-extrabold">Please Give Some Time...</p>  </div> : ""
        }

        <h2 className="text-4xl  font-semibold text-center mb-5 text-black py-6">
          Sign Up as a Rider
        </h2>
        <p className="text-xl ml-9 font-bold">Are you a Learner? <Link className="text-blue-600 underline" to='/'>Please signup as a learner...</Link></p>
        <div className="w-full p-7">
          <form onSubmit={handleSubmit(handleSignUp)}>
            ...
            <div className="text-center my-10">
              ...
              <button
                className="btn bg-gray-400 text-black text-xl font-bold lg:w-1/4 hover:bg-slate-900 hover:text-white"
                type="submit"
              >
                Sign Up
              </button>
